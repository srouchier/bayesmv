...
The Stan code for the full model is written in a separate file `changepoint.stan`. We only show some parts of it here. See [Tutorial 1](#optClinreg) for a quick introduction on the components of a Stan model.
